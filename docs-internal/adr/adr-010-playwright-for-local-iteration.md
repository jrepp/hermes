...
- Used by humans and agents to navigate, snapshot, fill forms, and inspect network traffic on a running stack (typically the testing Docker Compose at `:4201`/`:8001`, ADR-006).
...
- ADR-006 (testing Docker Compose stack the suite targets)