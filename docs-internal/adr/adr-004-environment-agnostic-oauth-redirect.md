...
# ADR-004: Environment-Agnostic OAuth Redirect
...
- [ADR-012: Multi-Provider Auth Architecture](adr-012-multi-provider-auth-architecture.md) — broader auth model.
- [ADR-014: Dex Authentication Implementation](adr-014-dex-authentication-implementation.md) — concrete OIDC flow.