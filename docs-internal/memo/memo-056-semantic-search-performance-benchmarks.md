...
id: memo-056
created: 2026-04-24
title: RFC-014 Performance Benchmarks
author: Hermes Team
project_id: hermes
...
Performance benchmarks for RFC-014 Event-Driven Document Indexer with Semantic Search, measuring key operations including embedding generation, vector operations, and search queries.
