...
id: memo-044
created: 2026-04-24
title: 'RFC-009 Summary: Simplified Local Mode'
author: Hermes Team
project_id: hermes
...
- **RFC-009**: [Full RFC](rfc-009-simplified-local-mode.md) (detailed architecture)
- [**readme-local-workspace.md**](memo/readme-local-workspace.md): Existing local workspace provider
- [**readme-indexer.md**](memo/readme-indexer.md): Document indexing patterns
