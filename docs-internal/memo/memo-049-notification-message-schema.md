...
id: memo-049
created: 2026-04-24
title: 'RFC-013 Implementation: Message Schema and Templates'
author: Hermes Team
project_id: hermes
...
hermes-admin templates preview \
  --name document_approved \
  --backend mail \
  --context '{"DocumentShortName": "RFC-013", "ApproverName": "Alice"}'
...
See [rfc-013-addendum.md](./rfc-013-addendum.md) section 8 for template injection prevention:
