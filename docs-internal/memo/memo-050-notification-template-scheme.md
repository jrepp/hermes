...
id: memo-050
created: 2026-04-24
title: 'RFC-013 Addendum: Notification Template Scheme'
author: Hermes Team
project_id: hermes
...
This addendum defines the template resolution scheme for RFC-013 notifications. Templates are fully resolved on the Hermes server before being published to the notification queue, ensuring that notification workers remain stateless and backend-agnostic.
...
func TestNotificationE2E(t *testing.T) {
    ...
    assert.Contains(t, logs, "RFC-013 approved by Alice")
...
[AUDIT]   Subject: RFC-013 approved by Alice
[AUDIT]   Recipients: Doc Owner <owner@example.com>, Doc Owner (Slack: U12345)
[AUDIT]   Body:
**RFC-013: Notification System** has been approved!
