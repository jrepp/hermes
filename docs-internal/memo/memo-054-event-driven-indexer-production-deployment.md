...
id: memo-054
created: 2026-04-24
title: RFC-014 Production Deployment Guide
author: Hermes Team
project_id: hermes
...
This guide covers deploying the RFC-014 Event-Driven Document Indexer to production, including all dependencies, configuration, and operational considerations.
...
### Run RFC-014 Migrations

```bash
# Run all migrations including RFC-014
hermes migrate up

# Verify RFC-014 tables exist
...
{
  "dashboard": {
    "title": "RFC-014 Indexer Performance",
    "panels": [
      {
