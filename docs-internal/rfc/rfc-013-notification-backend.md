...
status: Draft
hermes-uuid: RFC-013-NOTIFICATION-BACKEND
document-type: RFC
document-number: RFC-013
...
- [rfc-013-message-schema.md](./rfc-013-message-schema.md) - Message format and templates
- [rfc-013-backends.md](./rfc-013-backends.md) - Backend implementations
- [rfc-013-docker-compose.md](./rfc-013-docker-compose.md) - Testing infrastructure
...
```json
{
  "DocumentShortName": "RFC-013",
  "DocumentTitle": "Notification System",
  "DocumentType": "RFC",
  "DocumentURL": "https://hermes.example.com/docs/RFC-013",
...
- **Slack**: `:white_check_mark: *RFC-013 has been approved*\n\n*Alice Smith* approved your RFC...`
- **Telegram**: `✅ *RFC-013 has been approved*\n\n*Alice Smith* approved your RFC...`
- **Discord**: `:white_check_mark: **RFC-013 has been approved**\n\n**Alice Smith** approved your RFC...`
...
**See**: [rfc-013-backends.md](./rfc-013-backends.md#template-storage-in-document-system) for complete implementation details.
...
**See**: [rfc-013-message-schema.md](./rfc-013-message-schema.md#template-storage) for detailed template management guide.

## Security Considerations

- **Message Encryption**: Redpanda supports TLS for broker communication (enable in production)
  - **Enhanced**: AES-256-GCM envelope encryption for PII in messages (see [rfc-013-addendum.md](./rfc-013-addendum.md#6-message-encryption-pii-protection))
...
- **Template Injection**: Validate template context to prevent injection attacks
  ...
  - **See**: [rfc-013-addendum.md](./rfc-013-addendum.md#8-template-injection-prevention)
...
- RFC-011: Edge-to-Central Architecture (notification delegation context)
...
1. **[rfc-013-message-schema.md](./rfc-013-message-schema.md)** - Message format, templates, template context, and template storage
2. **[rfc-013-backends.md](./rfc-013-backends.md)** - Backend implementations with template loading from document storage (audit, mail, Slack, Telegram, Discord)
3. **[rfc-013-docker-compose.md](./rfc-013-docker-compose.md)** - Docker Compose integration for testing
4. **[rfc-013-addendum.md](./rfc-013-addendum.md)** - Critical fixes and enhancements (retry logic, DLQ, encryption, graceful shutdown, template injection prevention)
