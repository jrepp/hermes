...
supersedes: ADR-081 (narrative content)
related:
  - ADR-081
  - ADR-073
  - RFC-084
...
# RFC-094: API Refactoring and Testing Strategy

> Migration history, integration-test framework, V1-vs-V2 analysis, and code metrics for the V2 provider-abstraction refactor. The binding architectural rule lives in [ADR-081](../adr/adr-081-api-refactoring-and-testing-strategy.md); this RFC preserves the narrative.
...
The binding architectural rule that came out of this work is recorded in [ADR-081](../adr/adr-081-api-refactoring-and-testing-strategy.md).
