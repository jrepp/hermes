...
supersedes: ADR-082 (narrative content)
related:
  - ADR-082
  - RFC-091
---

# RFC-095: Document Identification System (DocID)

> Type hierarchy, format examples, migration phases, performance benchmarks, and use cases for the `pkg/docid` system. The binding architectural rule lives in [ADR-082](../adr/adr-082-document-identification-system.md); this RFC preserves the narrative.
...
The binding architectural rule that came out of this work is recorded in [ADR-082](../adr/adr-082-document-identification-system.md).
